                                ...
                                <div class="box-1">
                                  ...
                                  <div class="box-3">
                                    <span style="font-size: 18px;">
                                      <a href="chapter5-oci-storage.php" class="previous"><i class="fa fa-arrow-left"></i> Previous</a> || 
                                      <a href="chapter7-oci-security.php" style="color: blue;"> 7. Security</a>
                                    <span>
                                  </div>
                                  <br><br>
