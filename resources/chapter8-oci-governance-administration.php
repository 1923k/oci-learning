    ...
    ?>
                        ...
                        <div class="bx1">
                             <div class="bx3" >
                                ...
                                <div class="box-1">
                                  <h3>Chapter 8. Governance and Administration</h3>
                                  <hr>
                                  <div class="box-2">
                                    <br>
                                  ...
                                  <div class="box-3">
                                    <span style="font-size: 18px;">
                                      <a href="chapter7-oci-security.php" class="previous"><i class="fa fa-arrow-left"></i> Previous</a> || 
                                      <a href="../examination/exam-dashboard.php" style="color: blue;">9. Practice Exam</a>
                                    <span>
                                  </div>
                                  <br><br>
