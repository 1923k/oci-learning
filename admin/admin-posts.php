                            ...
                            <div class="panel" style="margin-left: 10px; margin-right: 10px;">
                                <div style="width: 100%;"> 
                                    <h4 style="font-weight: bold">
                                        <li class="fa fa-sliders"></li> Manage Admin Posts
                                   
                                        <a href="admin-content.php" class="btn btn-default" style="float: right;  margin-right: 0px;">
                                ...
                                <div style="border: 1px solid powderblue; padding: 10px;">
                                    ...
                                    <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                                $query = mysqli_query($conn, "SELECT * FROM `message` WHERE email='admin@post'") or die(mysqli_error());
                                                $rowcount=1;
                                            ...
                                            <tr>
                                                ...
                                                <td style="word-spacing:20px;font-size: 1.5rem; color: blue;  ">
                                                    <?php echo '<a href="#admin-posts.php?id='. $fetch['id'] .'" class="mr-3" title="Edit Post" style="margin-left:20px; " ><i class="fa fa-edit"></i></a>' ?>
                                                    <a href="admin-posts.php?delete=<?php echo $fetch['id']; ?>" title="Delete Post" onclick="return confirm('Are you sure to DELETE this user details ?');" >
